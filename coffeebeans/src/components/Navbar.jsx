    ...
    return (
        <header className='flex items-center justify-between py-5 font-medium font-[Fraunces]'>
            ...
            <nav className='hidden sm:flex gap-5 text-sm text-gray-700 font-semibold' role="menu" aria-label="Main menu">
                <NavLink to='/' className='flex flex-col items-center gap-1' role="menuitem" tabindex="0">
                    <span>Home</span>
                    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
                </NavLink>
                <NavLink to='/collection' className='flex flex-col items-center gap-1' role="menuitem" tabindex="0">
                    <span>Collection</span>
                    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
                </NavLink>
                <NavLink to='/about' className='flex flex-col items-center gap-1' role="menuitem" tabindex="0">
                    <span>About</span>
                    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
                </NavLink>
                <NavLink to='/contact' className='flex flex-col items-center gap-1' role="menuitem" tabindex="0">
                    <span>Contact</span>
                    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
                </NavLink>
